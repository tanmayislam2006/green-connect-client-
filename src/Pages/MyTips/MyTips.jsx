...
const MyTips = () => {
  ...
  return (
    <div className="min-h-screen py-10 px-2 flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl rounded-lg shadow-lg overflow-x-auto border border-gray-200 dark:border-gray-700">
        {/* Browser-like header */}
        <div className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-700">
        ...
        <table className="min-w-full bg-transparent">
          ...
          <tbody>
            {myTips.map((tip) => (
              <tr
                key={tip._id}
                className="border-b border-gray-100 dark:text-white dark:border-gray-700 text-center"
              >
                ...
                <td className="py-3 px-4 font-semibold text-gray-800 dark:text-white align-middle">
                  {tip.title}
                </td>
                <td className="py-3 px-4 text-gray-600 hidden md:table-cell dark:text-gray-300 align-middle">
                  {tip.category}
                </td>
